...
public class Radians {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Owen's method: " + toRadians(degrees));
        System.out.println("java's method: " + Math.toRadians(degrees));
        ...
        System.out.println("Owen's method: " + toDegrees(radians));
        System.out.println("java's method: "+Math.toDegrees(radians));
    }
}
