...
If you invoke a value method and don't do anything with the result, ths returned value can be ignored. The program and method still executes, but there is extra code that does not serve purpose.
2. What happens if you use a void method as part of an expression? For example, try `System.out.println("boo!") + 7;`.
If you use this void method, a compilation error will result, where the void method does not return a value, and this expression expects a value for it.
