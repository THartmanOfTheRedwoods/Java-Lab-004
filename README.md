...
4. What is the output of this program?
      If flag < 0  the output is ik\rattle\ping zoop\boo-wa-ha-ha
      If flag > 0  the output is rattle zoop
